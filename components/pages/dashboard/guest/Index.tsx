...
import fetchCountries from "@/lib/fetchers/fetch-countries";
import OrganizationCard from "@components/pages/dashboard/guest/OrganizationCard";
import StudentCard from "@components/pages/dashboard/guest/StudentCard";
import TeacherCard from "@components/pages/dashboard/guest/TeacherCard";
...
export default async function GuestDashboard({ profile }: TProps) {
